...
class UserBranch extends StatefulWidget {
  //final Map<String, dynamic> userData;
  UserBranch();

  @override
  _UserBranchState createState() => _UserBranchState();
}

class _UserBranchState extends State<UserBranch> {
  String university = '';
                          ...
                          Container(
                              ...
                              child: Obx(() =>
                                  SearchField(
                                    ...
                                    controller: userDataControllerGet.branch,
                                    validator: (value) {
                                    ...
                                    onSuggestionTap: (x) {
                                      ...
                                      userDataControllerGet.userSelectedBranch(
                                          x.searchKey);
